...
const movies = [
    ...
    let html =` <article class="movie">
        ...
        <p><strong>Rating:</strong> ${movie.stars.length}</span></p>
        <p id='desc'>Greg Heffley begins his middle school journey, documenting his awkward, hilarious, and relatable experiences in his journal.</p>
        </article>`
